...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '918767327657' ;
...
global.email = 'divakarjainkar063@gmail.com' ;
global.github = 'https://github.com/DarshanDzns' ;
global.location = 'Pune India' ;
global.timezone  = process.env.TIME_ZONE || 'Asia/Kolkata'
global.gurl = 'https://instagram.com/divakar_.fr' ; // add your username
global.sudo =  process.env.SUDO || "918767327657" ;
global.devs = "917560920774"; //Dont change it From here
global.website = 'wa.me/918767327657' ; //wa.me/+91000000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/RpDtQ4U.jpg' ;
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'D E X BOT',
  ownername:  process.env.OWNER_NAME || `D I V A K A R🥷🏻`,
  author:  process.env.PACK_AUTHER || 'Darshandzns.inc', 
